...
class MELOViewLink extends JView
{
	/**
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_MELO_MANAGER_LINK_NEW') : JText::_('COM_MELO_MANAGER_LINK_EDIT'), 'link');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle($isNew ? JText::_('COM_MELO_LINK_CREATING') : JText::_('COM_MELO_LINK_EDITING'));
